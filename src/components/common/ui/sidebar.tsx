...
const SidebarTrigger = React.forwardRef<any, any>(
...
const SidebarGroupLabel = React.forwardRef<any, any>(
...
const SidebarGroupAction = React.forwardRef<any, any>(
  ({ className, asChild = false, ...props }, ref) => {
...
const SidebarMenuAction = React.forwardRef<any, any>(
...
const SidebarMenuSkeleton = React.forwardRef<any, any>(
...
const SidebarMenuSubItem = React.forwardRef<any, any>(({ ...props }, ref) => (
  <li ref={ref} {...props} />
));
